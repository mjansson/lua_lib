...
network_address_family_t network_address_type(const network_address_t*;
network_address_family_t network_address_family(const network_address_t*);
network_address_t** network_address_local(void);
bool network_address_equal(const network_address_t*, const network_address_t*);
void network_address_deallocate(network_address_t*);
void network_address_array_deallocate(network_address_t**);
network_address_t* network_address_ipv4_initialize(network_address_ipv4_t*);
network_address_t* network_address_ipv6_initialize(network_address_ipv6_t*);
...
uint32_t network_address_ipv4_ip(const network_address_t*);
void network_address_ipv6_set_ip(network_address_t*, struct in6_addr);
struct in6_addr network_address_ipv6_ip(const network_address_t*);
uint32_t network_address_ipv4_make_ip(unsigned char, unsigned char, unsigned char, unsigned char);
...
void network_module_parse_config(const char*, size_t, const char*, size_t, const json_token_t*, size_t);
...
network_socket_type_t socket_type(socket_t*);
