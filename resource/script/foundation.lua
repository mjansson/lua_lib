...
-- Symbol init
ffi.cdef[[void lua_symbol_load_foundation(void);]]
C.lua_symbol_load_foundation()
...
void* memory_reallocate(void*, size_t, unsigned int, size_t, unsigned int);
...
PROCESS_MACOS_USE_OPENAPPLICATION = 0x10,
