/* main.c  -  Resource bind test for lua library  -  Public Domain  -  2013 Mattias Jansson
 *
...
static test_suite_t test_resource_suite = {
    test_resource_application, test_resource_memory_system, test_resource_config, test_resource_declare,
    test_resource_initialize,  test_resource_finalize,      test_resource_event};
