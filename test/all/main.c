...
int main_initialize( void )
{
	...
	application.version = lua_version();
...
int main_run( void* main_arg )
{
	...
	log_infof( HASH_TEST, "Lua library v%s built for %s using %s (%s)", string_from_version_static( lua_version() ), FOUNDATION_PLATFORM_DESCRIPTION, FOUNDATION_COMPILER_DESCRIPTION, build_name );
