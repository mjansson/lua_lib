/* main.c  -  Render bind test for lua library  -  Public Domain  -  2013 Mattias Jansson
 *
...
static test_suite_t test_render_suite = {test_render_application, test_render_memory_system, test_render_config,
                                         test_render_declare,     test_render_initialize,    test_render_finalize,
                                         test_render_event};
